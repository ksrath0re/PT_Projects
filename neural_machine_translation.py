#Code originally at https://pytorch.org/tutorials/intermediate/seq2seq_translation_tutorial.html
...
def readLangs(lang1, lang2, reverse=False):
    ...
    lines = open('trans_data/fra-eng.txt', encoding='utf-8').read().strip().split('\n')
    print(lines[10])
...
def prepareData(lang1, lang2, reverse=False):
    ...
    print("Trimmed to %s sentence pairs" % len(filtered_pairs))
